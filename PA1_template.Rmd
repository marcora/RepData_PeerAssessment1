...
Check the column transformations and the number of rows.
...
Create new dataset from the original one by replacing the missing values with the mean number of steps taken, averaged across all days, for that interval.
...
The new mean and median total number of steps taken per day are `r new.mean_total_steps_per_day` and `r new.median_total_steps_per_day`, respectively.
